#!/bin/bash
#SBATCH --job-name=jaspar_seqonly_maskon
#SBATCH --partition=compsci
#SBATCH --cpus-per-task=4
#SBATCH --mem=48G
#SBATCH --time=6:00:00
#SBATCH --array=0-5
#SBATCH --output=/usr/project/xtmp/nd141/programs/roboNhat_w_new_changes_claude/analysis/logs/jaspar_seqonly_maskon_%A_%a.out
#SBATCH --error=/usr/project/xtmp/nd141/programs/roboNhat_w_new_changes_claude/analysis/logs/jaspar_seqonly_maskon_%A_%a.err
...
# chrI, 6-way split. Sequence only, ABF1-only hard mask.
