#!/bin/bash
#SBATCH --job-name=concScore
#SBATCH --partition=compsci
#SBATCH --cpus-per-task=2
#SBATCH --mem=96G
#SBATCH --time=2:00:00
#SBATCH --array=0-14
#SBATCH --output=/usr/project/xtmp/nd141/programs/roboNhat_w_new_changes_claude/analysis/logs/concScore_%A_%a.out
#SBATCH --error=/usr/project/xtmp/nd141/programs/roboNhat_w_new_changes_claude/analysis/logs/concScore_%A_%a.err
...
ROW=$(grep -v '^[[:space:]]*#' conc_sweep_lo_runs.tsv | grep -v '^[[:space:]]*$' \
