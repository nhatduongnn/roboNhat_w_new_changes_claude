#!/bin/bash
#SBATCH --job-name=concRefine
#SBATCH --partition=compsci
#SBATCH --cpus-per-task=2
#SBATCH --mem=96G
#SBATCH --time=2:00:00
#SBATCH --array=0-2
#SBATCH --output=/usr/project/xtmp/nd141/programs/roboNhat_w_new_changes_claude/analysis/logs/concRefine_%A_%a.out
#SBATCH --error=/usr/project/xtmp/nd141/programs/roboNhat_w_new_changes_claude/analysis/logs/concRefine_%A_%a.err
...
python score_robocop.py "$OUTDIR" --label "$LABEL" \
       --out "conc_scores/report_${LABEL}.json"
