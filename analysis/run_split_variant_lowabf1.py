"""chrI decode, lowabf1 variant -- Fiber-seq + sequence, MASK OFF.
...
"""
import sys, os
sys.path.insert(0, 'pkgvar/seq_maskoff_lowabf1/')
...
print("=== run_split_variant_lowabf1 ===")
print("pkg variant:", os.path.abspath('pkgvar/seq_maskoff_lowabf1/'))
