#!/bin/bash
#SBATCH --job-name=chrI_em10nc
#SBATCH --partition=compsci
#SBATCH --cpus-per-task=4
#SBATCH --mem=48G
#SBATCH --time=6:00:00
#SBATCH --array=0-5
#SBATCH --output=/usr/project/xtmp/nd141/programs/roboNhat_w_new_changes_claude/analysis/logs/chrI_em10nc_%A_%a.out
#SBATCH --error=/usr/project/xtmp/nd141/programs/roboNhat_w_new_changes_claude/analysis/logs/chrI_em10nc_%A_%a.err
...
python run_split_em10_decode.py coord_chrI_full.tsv robocop_train_em10_chrII_nocap ./robocop_chrI_seq_maskoff_em10nocap/ "$SLURM_ARRAY_TASK_ID" 6
