"""chrI decode, variant capA -- all TFs, Fiber-seq + sequence layers, MASK OFF.
...
"""
import sys, os
sys.path.insert(0, 'pkgvar/seq_maskoff_capA/')
...
print("=== run_split_variant_capA ===")
print("pkg variant:", os.path.abspath('pkgvar/seq_maskoff_capA/'))
