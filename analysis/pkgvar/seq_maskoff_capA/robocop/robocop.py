...
def update_data_emission_matrix_using_fiber_seq_counts_Bionomial(
    ...
    with open('inputs/all_TFs_1000pealVal_params_pseudo_caplow.pkl', 'rb') as f:  # VARIANT capA: combined_low_count capped at bg
        loaded_params = pickle.load(f)
    ...
    # Load parameters (now contains probabilities 'p')
    with open('inputs/bg_params_merged.pkl', 'rb') as f:  # VARIANT capA: bg refit on MERGED pileup
