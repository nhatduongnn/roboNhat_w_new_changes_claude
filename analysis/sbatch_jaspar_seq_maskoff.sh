#!/bin/bash
#SBATCH --job-name=jaspar_seq_maskoff
#SBATCH --partition=compsci
#SBATCH --cpus-per-task=4
#SBATCH --mem=48G
#SBATCH --time=6:00:00
#SBATCH --array=0-5
#SBATCH --output=/usr/project/xtmp/nd141/programs/roboNhat_w_new_changes_claude/analysis/logs/jaspar_seq_maskoff_%A_%a.out
#SBATCH --error=/usr/project/xtmp/nd141/programs/roboNhat_w_new_changes_claude/analysis/logs/jaspar_seq_maskoff_%A_%a.err
...
# chrI, 6-way split. Fiber + sequence, MASK OFF -- all 154 TFs compete.
...
python run_split_revfix_seq_maskoff.py coord_chrI_full.tsv robocop_train_jaspar ./robocop_chrI_seq_maskoff_JASPAR/ "$SLURM_ARRAY_TASK_ID" 6
