"""chrI decode for the reverse-complement fix, variant: seq_maskon.

Identical to run_fiberonly_split.py except it imports the package variant
pkgvar/seq_maskon/, which has the layer/mask toggles BAKED IN rather than
...
"""
import sys, os
sys.path.insert(0, 'pkgvar/seq_maskon/')
...
print("=== run_split_revfix_seq_maskon ===")
print("pkg variant:", os.path.abspath('pkgvar/seq_maskon/'))
...
print("=== run_split_revfix_seq_maskon done (idx %d/%d) ===" % (idx, total))
